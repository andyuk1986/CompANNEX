...
public class FeedbackMethods {
	...
	private static FeedbackMethods instance = null;
	
	private FeedbackDao feedbackDao;
	
	private FeedbackMethods() {	
	}
	
	public static FeedbackMethods getInstance() {
		if (instance == null) instance = new FeedbackMethods();
		return instance;
	}
	...
	public List<Feedback> getLatestFeedbacks() {
		...
		Feedback feedb1 = new Feedback();
		feedb1.setPerson("John Smith");
		feedb1.setPosition("Manager");
		feedb1.setText("Lorem ipsum dolor sit amet, consectetur adipis icing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.");
		...
		feedb2.setPerson("Abraam Lincoln");
		feedb2.setPosition("CEO");
		feedb2.setText("Lorem ipsum dolor sit amet, consectetur adipis icing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.");
	...
	public List<Feedback> getAllFeedbacks() {
		List<Feedback> feedbacks = getLatestFeedbacks();
		
		Feedback feedb2 = new Feedback();
		feedb2.setPerson("Benjamin Franklin");
		feedb2.setPosition("President");
		feedb2.setText("Lorem ipsum dolor sit amet, consectetur adipis icing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.");
