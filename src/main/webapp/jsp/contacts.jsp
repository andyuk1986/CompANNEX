                ...
                <div class="wrapper">
                    ...
                    <article class="grid_3">
                        ...
                        <dl>
                            ...
                            <dd><span>Email:</span> <a class="link" href="contacts.jsp#">mail@demolink.org</a></dd>
                        </dl>
                    </article>
                </div>
            </div>
            	...
            	<div class="wrapper">
                	<article class="grid_3">
                    	<ul class="list-services">
                        	<li class="item-1"><a class="tooltips" title="facebook" href="contacts.jsp#"></a></li>
                            <li class="item-2"><a class="tooltips" title="twiiter" href="contacts.jsp#"></a></li>
                            <li class="item-3"><a class="tooltips" title="delicious" href="contacts.jsp#"></a></li>
                            <li class="item-4"><a class="tooltips" title="youtube" href="contacts.jsp#"></a></li>
                        </ul>
                    </article>
                    <article class="grid_3">
