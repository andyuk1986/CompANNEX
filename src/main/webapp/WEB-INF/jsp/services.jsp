                	...
                	<article class="grid_12">
                        ...
                        <div class="wrapper indent-bot">
                        	<article class="grid_4 alpha">
                            	<div class="wrapper">
                                	<figure class="img-indent2"><img src="jsp/images/page3-img1.png" alt=""></figure>
                                    <div class="extra-wrap">
                                    	<strong class="title-1">Strategic Planning</strong>
                                        Sedut perspiciatis unde omnis iste natus error sit voluptatem dolormqe laudantium, totam rem aperiam eaque ipsa quae ab illo inventore.
                                    </div>
                                </div>
                            </article>
                            <article class="grid_4">
                            	<div class="indent-left">
                                    <div class="wrapper">
                                        <figure class="img-indent2"><img src="jsp/images/page3-img2.png" alt=""></figure>
                                        <div class="extra-wrap">
                                            <strong class="title-1">Clients Relationships</strong>
                                            Veritati qusi architecto beatae vitae dictsut eplicabo nemo ipsam volupate quia voluptas sit aspernatur auodit aut fugit, sed quia.
                                        </div>
                                    </div>
                                </div>
                            </article>
                            <article class="grid_4 omega">
                            	<div class="indent-left">
                                    <div class="wrapper">
                                        <figure class="img-indent2"><img src="jsp/images/page3-img3.png" alt=""></figure>
                                        <div class="extra-wrap">
                                            <strong class="title-1">Insurance Services</strong>
                        ...
                        <div class="wrapper p2">
                        	<article class="grid_4 alpha">
                            	<div class="wrapper">
                                	<figure class="img-indent2"><img src="jsp/images/page3-img4.png" alt=""></figure>
                                    <div class="extra-wrap">
                                    	<strong class="title-1">Risk Management</strong>
                                        Veritati qusi architecto beatae vitae dictsut eplicabo nemo ipsam volupate quia voluptas sit aspernatur auodit aut fugit, sed quia.
                                    </div>
                                </div>
                            </article>
                            <article class="grid_4">
                            	<div class="indent-left">
                                    <div class="wrapper">
                                        <figure class="img-indent2"><img src="jsp/images/page3-img5.png" alt=""></figure>
                                        <div class="extra-wrap">
                                            <strong class="title-1">Investments</strong>
                                            Consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor.
                                        </div>
                                    </div>
                                </div>
                            ...
                            <article class="grid_4 omega">
                            	<div class="indent-left">
                                    <div class="wrapper">
                                        <figure class="img-indent2"><img src="jsp/images/page3-img6.png" alt=""></figure>
                                        <div class="extra-wrap">
                                            <strong class="title-1">Sales Leadership </strong>
            	...
            	<div class="wrapper">
                	<article class="grid_3">
                    	<ul class="list-services">
                        	<li class="item-1"><a class="tooltips" title="facebook" href="services.jsp#"></a></li>
                            <li class="item-2"><a class="tooltips" title="twiiter" href="services.jsp#"></a></li>
                            <li class="item-3"><a class="tooltips" title="delicious" href="services.jsp#"></a></li>
                            <li class="item-4"><a class="tooltips" title="youtube" href="services.jsp#"></a></li>
                        </ul>
                    </article>
                    <article class="grid_3">
